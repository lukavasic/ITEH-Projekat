...
const router = express.Router(); //metoda koja nam dozvoljava da definisemo rute u razlicitim fajlovima, ne moraju sve biti u server.js
...
router.post("/register", registerUserValidator, registerUser);//na ovoj ruti poziva se funkcija registerUser
                                                              //registerUserValidator je  funkcija za validaciju korisnika prilikom registrovanja koja definisemo u middleware expressValidato.js uz koriscenje express-validator paketa
