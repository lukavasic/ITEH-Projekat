      ...
      {dataType === "" ? (
        <form className="change-profile-section">
          <div className="input-wrapper" onClick={() => onChange("userName")}>
            <p className="font__bold p__size font__p">Promeni korisničko ime</p>
          </div>

          <div className="input-wrapper" onClick={() => onChange("name")}>
            <p className="font__bold p__size font__p">Promeni ime</p>
          </div>

          <div className="input-wrapper" onClick={() => onChange("lastName")}>
            <p className="font__bold p__size font__p">Promeni prezime</p>
          </div>
        </form>
      ) : (
        <form className="change-profile-section">
          <p className="font__bold  p__size">Izvrši promenu: </p>
          <input
            onChange={(e) => {
