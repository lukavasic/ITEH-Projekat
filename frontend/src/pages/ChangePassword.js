    ...
    <div className="change-profile-page-wrapper">
      {isAllowedToChangePassword === false && (
        <form className="change-profile-section">
          ...
          >
            <label className="change-password-label p__size app_color_font font__bold">
              Ukucaj trenutnu lozinku
            </label>
            <input
              className="change-password-input"
              placeholder="Ukucaj nešto..."
              type="text"
              value={firstPassword}
              name="firstPassword"
      ...
      {isAllowedToChangePassword && (
        <form className="change-profile-section">
          <div className="change-password-input-wrapper">
            ...
            <input
              placeholder="Ukucaj novu lozinku..."
              value={newPassword}
              name="newPassword"
              onChange={(e) => onChange(e)}
              type="text"
      ...
      {isAllowedToChangePassword && errors && isSubmitted && (
        <PasswordChangeMessage message="Lozinka nije promenjena, probaj ponovo..." />
      )}

      {isAllowedToChangePassword && !errors && isSubmitted && (
        <PasswordChangeMessage message="Lozinka uspešno promenjena" />
      )}
    </div>
  );
};
